...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trim/CODE/ROBO/part_2/robots_with_ROS/src/publisher/${idir}'.  Ask the maintainer 'trim <trim@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/trim/CODE/ROBO/part_2/robots_with_ROS/devel/lib;/opt/ros/kinetic/lib)
