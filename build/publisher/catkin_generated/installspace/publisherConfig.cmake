...
if("FALSE" STREQUAL "TRUE")
  set(publisher_SOURCE_PREFIX /home/trim/CODE/ROBO/part_2/robots_with_ROS/src/publisher)
  set(publisher_DEVEL_PREFIX /home/trim/CODE/ROBO/part_2/robots_with_ROS/devel)
  ...
  set(publisher_INSTALL_PREFIX /home/trim/CODE/ROBO/part_2/robots_with_ROS/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'publisher' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'trim <trim@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trim/CODE/ROBO/part_2/robots_with_ROS/install/${idir}'.  Ask the maintainer 'trim <trim@todo.todo>' to fix it.")
    endif()
